...
const address = data.split("&")[0].split("=")[1]
const amount = data.split("&")[1].split("=")[1]


let signerKeypair = web3.Keypair.fromSecretKey(from_b58("SOME"))
const result = await transfer(Integer.parseInt(amount), address, signerKeypair)
